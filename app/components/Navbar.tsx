    ...
    <>
      ...
      <header
        ...
        className="fixed inset-0 isolate z-40 h-full w-full
          bg-zinc-100/70 shadow
          backdrop-blur-lg transition-transform
          duration-500 data-[visible=false]:translate-x-full
          data-[visible=true]:translate-x-0
          dark:bg-zinc-950/70 md:h-14 md:data-[visible=false]:translate-x-0 md:data-[visible=false]:opacity-100"
      >
        <nav
          className="outline-b container flex h-full w-full flex-col items-center justify-center gap-8
            text-center md:flex-row md:justify-between"
        >
          {/* links section */}
