...
export default async function Carreer() {
  ...
  return (
    <section
      id="carreer"
      className="relative mx-auto grid gap-4 from-transparent from-5% via-primary to-transparent after:absolute after:left-4 after:h-full after:w-1 after:bg-gradient-to-b md:w-3/4 md:after:left-2/4"
    >
      <header>
